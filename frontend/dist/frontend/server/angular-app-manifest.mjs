...
export default {
  ...
  assets: {
    ...
    'portfolio/index.html': {size: 7076, hash: '5194d862be8aba4b1bf3c54b6a798f9135f170b1b75887f5c4503acfbc2da288', text: () => import('./assets-chunks/portfolio_index_html.mjs').then(m => m.default)},
